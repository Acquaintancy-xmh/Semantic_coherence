...
from transformers.focal_loss import FocalLoss
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None,
        ...
        if labels is not None:
            if self.num_labels == 1:
                ...
                # focal_loss = FocalLoss(class_num=self.config.num_labels, alpha=0.25)
                # loss = focal_loss(logits.view(-1, self.num_labels), labels.view(-1))  # Focal Loss
